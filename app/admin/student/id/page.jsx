  ...
  const fetchStudents = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        console.log("Students set:", data.students); // 👈 Debug log
      }
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-6">
      ...
      <form
        ...
        className="print:hidden max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 mb-10 bg-white p-6 rounded-xl shadow-md"
      >
        <div>
      ...
      {/* ID Cards Grid */}
      {/* ID Cards Grid */}
{/* ID Cards - One per page */}
{!loading && students.length > 0 && (
  <div className="printable-area flex flex-wrap gap-6 justify-start">
    {students.map((student) => (
      <div
        key={student.studentID}
        className="break-inside-avoid flex-shrink-0"
      >
