...
// export default function StudentExercise() {
//   const [examList, setExamList] = useState([]); // ✅ always an array
//   const [selectedTitle, setSelectedTitle] = useState(null);
//   const [exam, setExam] = useState(null);
//   const [currentIndex, setCurrentIndex] = useState(0);
//   const [selectedAnswer, setSelectedAnswer] = useState(null);
...
//       setExamList(Array.isArray(data.exams) ? data.exams : []); // ✅ ensure array
//       setStudentId(data.studentId || null);
//     } catch (err) {
//       console.error('Error fetching exam list:', err);
//       setError(err.message);
//       setExamList([]); // ✅ fallback
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       setTimeLeft(data.exam?.durationMinutes ? data.exam.durationMinutes * 60 : null);
//       setCurrentIndex(0);
//       setSelectedAnswer(null);
//       setShowResult(false);
//     } catch (err) {
...
//   const handleNext = () => {
//     if (exam && currentIndex < (exam.questions?.length || 0) - 1) {
//       setCurrentIndex(currentIndex + 1);
//       setSelectedAnswer(null);
//       setShowResult(false);
//     } else {
...
//               <div className="bg-white shadow-lg p-6 rounded-xl">
//                 <h3 className="text-xl font-semibold text-gray-700 mb-4">
//                   Question {currentIndex + 1}/{exam.questions?.length || 0}
//                 </h3>
//                 <p className="text-lg font-medium text-gray-700 mb-4">
//                   {exam.questions[currentIndex].content}
//                 </p>
...
//                     >
//                       Your Answer: {selectedAnswer} (
//                       {selectedAnswer === exam.questions[currentIndex].correct ? '✅ Correct' : '❌ Incorrect'})
//                     </p>
//                     <p className="text-lg text-gray-700">
//                       Correct Answer: {exam.questions[currentIndex].correct}
//                     </p>
...
//                   className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-blue-700 transition"
//                 >
//                   {currentIndex < (exam.questions?.length || 0) - 1 ? 'Next Question' : 'Finish'}
//                 </button>
//               </div>
//             )}
//           </div>
