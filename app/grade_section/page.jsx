  ...
  return (
    <div className="max-w-lg mx-auto mt-10 p-8 bg-white text-gray-700 shadow-lg rounded-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label className="block text-sm font-semibold mb-2 text-gray-700">Grade</label>
          <input
            type="number"
            value={grade}
        ...
        <div>
          <label className="block text-sm font-semibold mb-2 text-gray-700">Sections</label>
