...
//     return;
//   }
// // replace just this part of your handleLogin:
// const res = await signIn(provider, {
//   redirect: false,
//   callbackUrl: "/route-by-role",
//   ...formData,
// });

// if (res?.ok) {
//   // IMPORTANT: don't call getSession() here — it can be stale.
//   // Let the server read the session and redirect to the right place.
//   router.replace("/route-by-role"); // avoids history entry for the login page
//   router.refresh();                 // make sure RSC pick up the new session
//   return;
// } else {
//   if (res?.error === "429") {
//     setError("Too many login attempts. Please wait 10 minutes.");
